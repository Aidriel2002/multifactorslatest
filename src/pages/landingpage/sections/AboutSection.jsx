              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    To be the most trusted technical backbone for society, powering a world where every system works as intended.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 backdrop-blur-lg rounded-2xl p-8 border border-gray-200 hover:border-[#235312] shadow-md hover:shadow-xl transition-all duration-500 hover:transform hover:scale-105">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Delivering precise, custom-fit technical systems to government and private partners through transparent and innovative integration.
                  </p>
                </div>
              </div>
            </div>
