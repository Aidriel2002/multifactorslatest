      ...
      <div className="flex flex-col h-screen w-64 bg-gradient-to-b from-green-900 to-green-600 text-white">
        ...
        <div className="border-t border-green-700 p-4">
          <div className="relative">
            ...
            >
              <div className="w-10 h-10 rounded-full bg-green-700 flex items-center justify-center text-white font-bold mr-3">
              ...
              <svg
                className={`w-5 h-5 text-green-200 transition-transform ${
